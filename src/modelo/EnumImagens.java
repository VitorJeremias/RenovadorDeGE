...
public enum EnumImagens {
	...
	//CENTRALIZADO_10
	ATIVIDADE(StringConstants.pathRenovadorDeGE + "atividade.png", EnumParametrosImagem.CENTRALIZADO_10, "atividade"),
	...
	GRANDES_EDIFICIOS(StringConstants.pathRenovadorDeGE + "grandesEdificios.png", EnumParametrosImagem.CENTRALIZADO_10, "GrandesEdificios"),	
	...
	VITOR_MONTICELLI(StringConstants.pathRenovadorDeGE + "vitorMonticelli.png",EnumParametrosImagem.CENTRALIZADO_10, "vitorMonticelli"),
